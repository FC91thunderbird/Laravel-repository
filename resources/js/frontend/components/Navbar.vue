...
<template>
  ...
  <div class="header-mobile header_sticky">
    <div class="container d-flex align-items-center h-100">
      ...
      <div class="logo">
        <a href="/">
          <img :src='"/storage/logo/" + authUser.setting.logo' :alt="authUser.setting.sitename"
    ...
    <nav
      ...
      <div class="container">
        <form action="https://uomo-html.flexkitux.com/Demo12/search.html" method="GET"
            ...
            <li class="navigation__item">
              ...
              <div class="sub-menu position-absolute top-0 start-100 w-100 d-none">
                ...
                <ul class="list-unstyled">
                  <li class="sub-menu__item"><a href="https://uomo-html.flexkitux.com/Demo1/index.html"
                      class="menu-link menu-link_us-s">Home 1</a></li>
                  <li class="sub-menu__item"><a href="https://uomo-html.flexkitux.com/Demo2/index.html"
                      class="menu-link menu-link_us-s">Home 2</a></li>
                  <li class="sub-menu__item"><a href="https://uomo-html.flexkitux.com/Demo3/index.html"
                      class="menu-link menu-link_us-s">Home 3</a></li>
                  <li class="sub-menu__item"><a href="https://uomo-html.flexkitux.com/Demo4/index.html"
                      class="menu-link menu-link_us-s">Home 4</a></li>
                  <li class="sub-menu__item"><a href="https://uomo-html.flexkitux.com/Demo5/index.html"
                      class="menu-link menu-link_us-s">Home 5</a></li>
                  <li class="sub-menu__item"><a href="https://uomo-html.flexkitux.com/Demo6/index.html"
                      class="menu-link menu-link_us-s">Home 6</a></li>
                  <li class="sub-menu__item"><a href="https://uomo-html.flexkitux.com/Demo7/index.html"
                      class="menu-link menu-link_us-s">Home 7</a></li>
                  <li class="sub-menu__item"><a href="https://uomo-html.flexkitux.com/Demo8/index.html"
                      class="menu-link menu-link_us-s">Home 8</a></li>
                  <li class="sub-menu__item"><a href="https://uomo-html.flexkitux.com/Demo9/index.html"
                      class="menu-link menu-link_us-s">Home 9</a></li>
                  <li class="sub-menu__item"><a href="https://uomo-html.flexkitux.com/Demo10/index.html"
                      class="menu-link menu-link_us-s">Home 10</a></li>
                  <li class="sub-menu__item"><a href="https://uomo-html.flexkitux.com/Demo11/index.html"
                      class="menu-link menu-link_us-s">Home 11</a></li>
                  <li class="sub-menu__item"><a href="index.html" class="menu-link menu-link_us-s">Home 12</a></li>
                  <li class="sub-menu__item"><a href="https://uomo-html.flexkitux.com/Demo13/index.html"
                      class="menu-link menu-link_us-s">Home 13</a></li>
                  <li class="sub-menu__item"><a href="https://uomo-html.flexkitux.com/Demo14/index.html"
                      class="menu-link menu-link_us-s">Home 14</a></li>
                  <li class="sub-menu__item"><a href="https://uomo-html.flexkitux.com/Demo15/index.html"
                      class="menu-link menu-link_us-s">Home 15</a></li>
                  <li class="sub-menu__item"><a href="https://uomo-html.flexkitux.com/Demo16/index.html"
  ...
  <div class="header-desk_type_7">
    <div class="header-top theme-bg-color-secondary">
      <div class="container d-flex align-items-center">
        <div class="logo">
          <a href="/">
            <img :src='"/storage/logo/" + authUser.setting.logo' :alt="authUser.setting.sitename" class="logo__image">
          </a>
        </div><!-- /.logo -->
        ...
        <div class="header-tools d-flex align-items-center">
          <div class="dropdown" v-if="customer.isCustomer">
            <a class="header-tools__item dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <i class="fa fa-user" ></i>
              {{ customer.user.first_name }}
            </a>
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <router-link :to="{ name:'account' }" class="dropdown-item">My Account</router-link>
                <router-link to="" class="dropdown-item">Another action</router-link>
                <a @click="logoutCustomer()" class="dropdown-item">Logout</a>
              </div>
          </div>

          <router-link :to="{name:'login'}" class="header-tools__item" v-else>
            Login/Register
          </router-link>
          ...
          <router-link :to="{ name: 'cart'}" class="header-tools__item header-tools__cart js-open-aside"
            data-aside="cartDrawer">
            <i class="fa fa-shopping-cart"></i>
            <span class="cart-count d-block position-absolute js-cart-items-count theme-bg-color">{{
              Object.keys(cartStore.cartItems).length }}</span>
            <span class="cart-amount d-block position-absolute js-cart-items-count theme-bg-color">{{
              cartStore.totalCost }}</span>
          </router-link>
      ...
      <div class="container d-flex align-items-center">
        <nav class="navigation">
          <ul class="navigation__list list-unstyled d-flex">
            <li class="navigation__item">
              <router-link :to="{ name:'homepage'}" class="navigation__link">Home</router-link>
            </li>
            <li class="navigation__item">
              <router-link :to="{ name: 'cart'}" class="navigation__link">Cart</router-link>
            </li>
            <li class="navigation__item">
              <router-link :to="{name: 'shop'}" class="navigation__link">Shop</router-link>
            </li>
            <li class="navigation__item">
