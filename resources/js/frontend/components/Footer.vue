    ...
    <div class="footer-middle container">
      <div class="row row-cols-lg-5 row-cols-2">
        ...
        <div class="footer-column footer-newsletter col-12 mb-4 mb-lg-0">
          ...
          <form action="https://uomo-html.flexkitux.com/Demo12/" class="footer-newsletter__form position-relative bg-body">
      ...
      <div class="d-block d-md-flex align-items-center">
        ...
        <div class="footer-settings d-block d-md-flex align-items-center">
          <div class="d-flex align-items-center">
            ...
            <select id="footerSettingsLanguage" class="form-select form-select-sm bg-transparent border-0 color-white" aria-label="Default select example" name="store-language">
          ...
          <div class="d-flex align-items-center">
            ...
            <select id="footerSettingsCurrency" class="form-select form-select-sm bg-transparent border-0 color-white" aria-label="Default select example" name="store-language">
